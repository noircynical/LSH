#ifndef _LSH160_GENERIC_H
#define _LSH160_GENERIC_H
//////////////////////////////////////////////////////
#include "lsh_common.h"

/* number of steps for LSH-160-n */
#define NS160  20

typedef struct  {
    u32 cv160[16];         /* current chain value */
    Byte data160[80];	/* remaining data*/
    int hashbitlen;    /* length of the hash value (bits) */
    int databitlen;       /*amount of remaining data(data256) to hash in bits*/
} hashState160;
...
//rotation amounts
static const int gamma160[8] = { 0, 8, 16, 24, 24, 16, 8, 0 };
